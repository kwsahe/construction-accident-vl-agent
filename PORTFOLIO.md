...
SPilot VL Accident Judgment Agent는 건설현장 CCTV 영상을 프레임 단위로 분석해 사고 발생 여부, 사고 유형, 사고 경위, 사고 원인 관련 근거를 판단하는 Vision-Language Agent 프로토타입입니다.
...
건설현장 CCTV 사고 영상은 사람이 직접 전체 영상을 확인해야 사고 순간과 사고 유형을 판단할 수 있습니다. 특히 이동식 비계 사고처럼 사고 전 행동, 구조물 이동, 상부 작업자 추락이 시간순으로 이어지는 경우에는 마지막 장면만 보고 단순 낙상으로 잘못 판단할 수 있습니다.
...
- 사고 유형, 부상자 수, 구조물 변화, 작업자 위치 변화, 사고 원인 판단 프롬프트 작성
...
사고 전 행동은 사고 자체가 아니라 경고 로그 또는 사고 경위의 근거로 사용했습니다.
...
이 설계 덕분에 단순 사고 유형과 사고 원인 설명을 분리할 수 있습니다.
...
- 사고 유형 분류와 원인 설명을 분리해 판단 결과와 서비스 데이터 구조를 개선
...
- 사고 원인 판단은 향후 tracking/pose/객체 탐지 결과와 결합해 정교화할 수 있습니다.
